        ...
        <div class="container">
          ...
          <div class="col-md-3 static">
            <div class="profile-card">
              ...
              @else
                <img src="{{ url("images/logo-black.png") }}" alt="" class="profile-photo" />  
              @endif
                      ...
                      <div class="panel panel-success" style="padding: 0px;">
                        <div class="panel-body">
                          <div class="col-md-2 col-sm-2 col-xs-2" style="padding: 0px;">
                            @if($profilepicture)
                            <img src="{{ url("profile/$profilepicture->image") }}" alt="" class="profile-photo-md" />   
                            @else
                            <img src="{{ url("images/logo-black.png") }}" alt="" class="profile-photo-md" />  
                            @endif
                          </div>
