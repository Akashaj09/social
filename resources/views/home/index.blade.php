        ...
        <div class="container">
          ...
          <div class="col-md-3 static">
            <div class="profile-card">
                <img src="{{ url("profile/$profilepicture->image") }}" alt="user" class="profile-photo" />
                <h5><a href="#" class="text-white">{{ Auth::user()->firstname }}&nbsp; {{ Auth::user()->lastname }}</a></h5>
                <a href="#" class="text-white"><i class="ion ion-android-person-add"></i> 1,299 followers</a>
                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#profileImage">Change image</button>
                    ...
                    <div class="panel panel-success" style="padding: 0px;">
                      <div class="panel-body">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-10" style="padding: 0px;">
                          <textarea class="form-control" rows="3" style="resize: none;" placeholder="What's on your mind"></textarea>
                        </div>
                      </div>
                      <div class="panel-footer" style="height: 57px;">
                        <div class="col-md-7 col-sm-7 col-xs-7" align="left" style="padding: 2px;">
                          ...
                          <label class="btn btn-primary btn-sm" for="postimage"><i class="fa fa-image"></i></label>
                        </div>
                        <div class="col-md-5 col-sm-5 col-xs-5" align="right" style="padding: 2px;">
                          <button type="button" class="btn btn-primary btns-sm" id="post">Post</button>
                        </div>
                      </div>
                    </div>
                  </div>
